...
# Fila 1: Módulo futuro
with st.container():
    st.subheader("🔧 Módulo en Desarrollo")
    st.info("Este espacio está reservado para futuros indicadores o gráficos.")
    st.markdown("---")

# Fila 2: Mapa interactivo
with st.container():
    st.subheader("🗺️ Mapa de Recorridos de Fibra")
...
# Fila 3: Distribución y métricas
with st.container():
    st.subheader("📊 Indicadores de Clientes y Distribución")
